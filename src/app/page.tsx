...
export const metadata: Metadata = {
  ...
  description: 'Fisioterapia especializada, pilates, liberação miofascial e fisioterapia pélvica em Florianópolis. Atendimento profissional no Ingleses com Natália Toledo. Agende sua consulta!',
  alternates: {
